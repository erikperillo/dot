 ...
 */
static char font[] = "Droid Sans Mono:pixelsize=11:antialias=true:autohint=true";
//static char font[] = "Liberation Mono:pixelsize=12:antialias=true:autohint=true";

static int borderpx = 0; //def=2
 ...
 * attribute.
 */
static unsigned int blinktimeout = 0; //def=800

/*
 * thickness of underline and bar cursors
 */
static unsigned int cursorthickness = 0; //def=2
...
static unsigned int tabspaces = 4; //def=8
 ...
 */
static unsigned int defaultfg = 251;
static unsigned int defaultbg = 233; //def=0
